...
export const metadata = {
  title: "VRMモデルの操作とアニメーション",
};

export default function Page() {
  return (
    <div>
      <H1>5. VRMモデルの操作とアニメーション</H1>
      <p>
        このセクションでは、VRMモデルの関節を操作してアニメーションを作成する方法を学びます。
      </p>

      <H2 className="mt-14">VRMモデルのボーン</H2>
      <p>
      ...
      <H2 className="mt-14">VRMモデルのボーンを操作する</H2>
      <p>
        ここでは、作成したVRMモデルを <Code>sample.vrm</Code>
        という名前で保存したとします。
        <br />
        サンプルのモデルファイルを
        <a className="text-blue-500 underline" href="/easy-three/model/sample.vrm" download>
          こちら
        </a>
        からダウンロードしても構いません。
        <br />
...
`}
      ...
      <H2 className="mt-14">VRMの表情を変える</H2>
      <p>モデルの表情を変えるには、</p>
